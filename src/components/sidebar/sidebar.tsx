...
function Sidebar() {
    ...
    return (
        <div className="w-[170px] h-full rounded-tl-[10px] rounded-bl-[10px] bg-gradient-to-b from-[rgba(0,181,160,1)] to-[rgba(0,198,155,1)]">
            <div className='w-full h-[50%] flex flex-col items-center justify-between pt-12'>
                ...
                <div className='flex flex-col items-center justify-between gap-8'>
                    <button
                        ...
                        onClick={() => dispatch(setActivePage('transcribe'))}
                    ...
                    <button
                        ...
                        onClick={() => dispatch(setActivePage('archive'))}
